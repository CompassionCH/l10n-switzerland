...
class TestAccountPaymentOrder(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.payment_method_ch_dd = cls.env["account.payment.method"].create(
            {
                "name": "Swiss PAIN Direct Debit",
                "code": "ch_pain_dd",
        ...
        cls.payment_mode_ch_dd = cls.env["account.payment.mode"].create(
            {
                "name": "Swiss PAIN DD Mode",
                "payment_method_id": cls.payment_method_ch_dd.id,
                "company_id": cls.company.id,
                "fixed_journal_id": cls.journal.id,
                "bank_account_link": "fixed",
            }
